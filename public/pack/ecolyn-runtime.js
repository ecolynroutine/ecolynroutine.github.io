...
async function submitOrder(form) {
  ...
  const record = {
    ...
    photo_data_url: null, photo_name: null, photo_consent: false, contact_consent: Boolean(data.get('contact_consent')), marketing_consent: false, language: language(), source: 'ecolyn_pack_builder', page_url: location.href.slice(0, 2000), referrer: document.referrer.slice(0, 2000) || null, utm_source: qs.get('utm_source'), utm_medium: qs.get('utm_medium'), utm_campaign: qs.get('utm_campaign'), utm_term: qs.get('utm_term'), utm_content: qs.get('utm_content')
  }
