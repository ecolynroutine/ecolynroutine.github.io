...
export const skinCases: SkinCase[] = [
  ...
  {
    id: 'traces', category: 'Traces de boutons',
  ...
  {
    id: 'grasse-tire', category: 'Peau grasse',
  ...
  {
    id: 'spf-oublie', category: 'Protection solaire',
  ...
  {
    id: 'routine-change', category: 'Routine confuse',
