...
export const adviceItems: AdviceItem[] = [
  ...
  },
  {
    ...
    title: { fr: 'Une peau qui brille peut quand même manquer d’eau', ar: 'قد تلمع البشرة ومع ذلك تفتقر إلى الماء' },
    explanation: { fr: 'Votre front peut briller quelques heures après le lavage alors que votre visage tire juste après le nettoyage. Ces sensations ne sont pas contradictoires : le sébum est une matière grasse, tandis que l’hydratation désigne l’eau retenue dans la peau.', ar: 'قد تلمع الجبهة بعد ساعات من الغسل بينما تشعرين بالشد مباشرة بعد التنظيف. لا يوجد تناقض: الدهون التي تفرزها البشرة تختلف عن الماء الذي تحتاج إلى الاحتفاظ به.' },
  ...
  },
  {
    ...
    title: { fr: 'Un produit qui brûle n’est pas nécessairement plus efficace', ar: 'المنتج الذي يسبب حرقاناً ليس بالضرورة أكثر فعالية' },
    explanation: { fr: 'Si un nouveau sérum ou une nouvelle crème provoque un picotement fort, une brûlure persistante ou une rougeur, cela peut correspondre à une irritation. Cette sensation ne prouve pas que les actifs agissent mieux ; elle peut simplement indiquer que votre peau ne tolère pas bien le produit ou sa fréquence.', ar: 'إذا سبب سيروم أو كريم جديد وخزاً قوياً أو حرقاناً مستمراً أو احمراراً، فقد تكون البشرة متهيجة. هذا الإحساس لا يثبت أن المكونات تعمل بشكل أفضل، بل قد يعني أن بشرتك لا تتحمل المنتج أو وتيرة استعماله.' },
    doItem: { fr: 'Rincez puis arrêtez le nouveau produit si la sensation devient forte ou persiste, et revenez temporairement à une routine simple.', ar: 'اغسلي بشرتك وأوقفي المنتج الجديد إذا أصبح الإحساس قوياً أو استمر، وعودي مؤقتاً إلى روتين بسيط.' },
    avoidItem: { fr: 'Ne continuez pas un produit qui provoque une douleur ou une brûlure durable dans l’espoir que la peau finira par s’y habituer.', ar: 'لا تواصلي استعمال منتج يسبب ألماً أو حرقاناً مستمراً على أمل أن تعتاد عليه بشرتك.' },
  ...
  },
  {
    ...
    title: { fr: 'Un bouton vidé peut laisser une marque bien plus longtemps', ar: 'قد تختفي الحبة بعد عصرها لكن يبقى أثرها مدة أطول' },
    explanation: { fr: 'La partie visible du bouton peut sembler disparaître plus vite après l’avoir pressé. Pourtant, la pression et les ongles peuvent aggraver l’inflammation sous la peau et augmenter le risque qu’une marque colorée ou une cicatrice reste visible.', ar: 'قد يبدو أن الحبة اختفت بسرعة بعد عصرها، لكن الضغط والأظافر قد يزيدان الالتهاب تحت الجلد ويرفعان احتمال بقاء أثر داكن أو ندبة.' },
  ...
  },
  {
    ...
    title: { fr: 'Un SPF50 appliqué trop légèrement protège moins que prévu', ar: 'طبقة خفيفة جداً من SPF50 قد لا تمنح الحماية المتوقعة' },
    explanation: { fr: 'Le niveau SPF50 indiqué sur l’emballage est mesuré avec une application standardisée. Une couche trop fine, oubliée sur certaines zones ou appliquée une seule fois pour toute la journée réduit la protection réellement obtenue.', ar: 'تُقاس درجة SPF50 باستعمال كمية محددة أثناء الاختبار. أما وضع طبقة رقيقة جداً أو نسيان بعض المناطق أو الاكتفاء بتطبيق واحد طوال اليوم فيقلل الحماية الفعلية.' },
    doItem: { fr: 'Appliquez généreusement un SPF50 large spectre environ 15 minutes avant l’exposition, puis renouvelez toutes les deux heures et après transpiration, baignade ou essuyage.', ar: 'ضعي كمية كافية من واقٍ واسع الطيف SPF50 قبل التعرض للشمس بنحو 15 دقيقة، وجدديه كل ساعتين وبعد التعرق أو السباحة أو مسح الوجه.' },
    avoidItem: { fr: 'Évitez de réserver le SPF50 à la plage ou de compter sur une couche très fine pour toute la journée.', ar: 'لا تجعلي SPF50 خاصاً بالشاطئ، ولا تعتمدي على طبقة خفيفة واحدة طوال اليوم.' },
  ...
  },
  {
    ...
    explanation: { fr: 'Certaines recherches associent le stress à une récupération moins efficace de la barrière cutanée, c’est-à-dire la couche protectrice qui aide la peau à retenir l’eau et à limiter les irritations. Le stress n’explique toutefois pas à lui seul chaque bouton ou chaque tache.', ar: 'تربط بعض الأبحاث التوتر ببطء تعافي حاجز البشرة، أي الطبقة الواقية التي تساعدها على الاحتفاظ بالماء وتقليل التهيج. لكن التوتر وحده لا يفسر كل حبة أو تصبغ.' },
  ...
  },
  {
    ...
    doItem: { fr: 'Gardez une routine courte et montrez la liste complète de vos produits à votre médecin, dermatologue ou pharmacien avant d’ajouter un actif ciblé.', ar: 'حافظي على روتين قصير، واعرضي قائمة منتجاتك كاملة على الطبيب أو طبيب الجلد أو الصيدلي قبل إضافة أي مكوّن فعال موجه.' },
  ...
  },
  {
    ...
    doItem: { fr: 'Associez un SPF50 large spectre à votre dernier geste du matin, puis prévoyez son renouvellement toutes les deux heures lors d’une exposition prolongée.', ar: 'اجعلي واقي SPF50 واسع الطيف آخر خطوة صباحية، وجدديه كل ساعتين عند التعرض المطول للشمس.' },
  ...
  {
    id: 'visible-light-iron-oxide', kind: 'concern', priority: 5, evidenceLevel: 'established', source: adviceSources.visibleLightStudy,
    ...
    doItem: { fr: 'Commencez par appliquer régulièrement un SPF50 large spectre en quantité suffisante. Une formule teintée avec oxydes de fer reste une option éducative à discuter si les taches persistent, pas une obligation.', ar: 'ابدئي أولاً باستعمال SPF50 واسع الطيف بانتظام وبكمية كافية. ويمكن مناقشة الواقي الملون المحتوي على أكاسيد الحديد كخيار إضافي إذا استمرت التصبغات، وليس كشرط إلزامي.' },
    avoidItem: { fr: 'N’abandonnez pas une protection SPF50 régulière uniquement parce qu’elle n’est pas teintée.', ar: 'لا تتوقفي عن استعمال واقي SPF50 بانتظام لمجرد أنه غير ملون.' },
    tags: { skinTypes: allSkin, concerns: ['taches', 'traces', 'spf'], contexts: ['sun'], complexions: ['medium-dark'] },
  },
  {
    id: 'retinoid-start-slow', kind: 'concern', priority: 2, evidenceLevel: 'established', source: adviceSources.aadRetinoid,
