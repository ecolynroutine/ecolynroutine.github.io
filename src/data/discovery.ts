...
export const discoveryCards: DiscoveryCard[] = [
  ...
  },
  {
    ...
    explanation: { fr: 'Une protection large spectre SPF50 constitue la base du parcours ECOLYN. Pour certaines taches, les oxydes de fer d’une formule teintée peuvent être une information complémentaire — sans devenir une obligation ni l’unique sujet de la routine.', ar: 'تشكل الحماية الواسعة SPF50 أساس مسار ECOLYN. وقد تكون أكاسيد الحديد في بعض الواقيات الملونة معلومة إضافية لبعض التصبغات، من دون أن تصبح شرطاً أو الموضوع الوحيد في الروتين.' },
