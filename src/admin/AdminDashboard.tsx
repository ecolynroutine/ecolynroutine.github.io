  ...
  return (
    <section className="admin-panel">
      ...
      <div className="tracking-events">
        ...
        <div>{['PageView', 'ViewContent', 'Lead / generate_lead', 'select_skin_profile', 'select_skin_concern', 'select_lifestyle_topic', 'content_open', 'content_complete', 'story_open', 'story_audio_play', 'JoinWhatsappGroup', 'Contact', 'InitiateCheckout', 'form_start', 'form_submit', 'whatsapp_click', 'pack_view', 'pack_cta_click', 'live_calendar_click'].map(event => <span key={event}>{event}</span>)}</div>
      </div>
